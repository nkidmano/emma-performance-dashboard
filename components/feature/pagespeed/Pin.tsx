...
export function Pin(props: PinProps) {
  return (
    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      <mask id="path-1-outside-1" maskUnits="userSpaceOnUse" x="3" y="0" width="10" height="16" fill="black">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 7.95852C9.91886 7.72048 11 6.4865 11 5C11 3.34315 9.65685 2 8 2C6.34315 2 5 3.34315 5 5C5 6.4865 6.08114 7.72048 7.5 7.95852V14H8.5V7.95852Z" />
      </mask>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 7.95852C9.91886 7.72048 11 6.4865 11 5C11 3.34315 9.65685 2 8 2C6.34315 2 5 3.34315 5 5C5 6.4865 6.08114 7.72048 7.5 7.95852V14H8.5V7.95852Z" fill="#5F6368" />
